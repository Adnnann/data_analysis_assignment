...
+-------+-------+-------+-------------+-------+-------+-------+-------+
| De    | De    | DMS   | Object that | N/S   | E/W   | E/W   | E/W   |
| cimal | cimal |       | can         | or    | at    | at    | at    |
| p     | de    |       | be un       | E/W   | 23N/S | 45N/S | 67N/S |
| laces | grees |       | ambiguously | at    |       |       |       |
|       |       |       |  recognized | eq    |       |       |       |
|       |       |       | at this     | uator |       |       |       |
|       |       |       | scale       |       |       |       |       |
+=======+=======+=======+=============+=======+=======+=======+=======+
| 0     | 1.0   | 1°    | country or  | 1     | 1     | 78    | 43    |
|       |       | 00′   | large       | 11 km | 02 km | .7 km | .5 km |
|       |       | 0″    | region      |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 1     | 0.1   | 0°    | large city  | 11    | 10    | 7.    | 4.    |
|       |       | 06′   | or district | .1 km | .2 km | 87 km | 35 km |
|       |       | 0″    |             |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 2     | 0.01  | 0°    | town or     | 1.    | 1.    | 0.7   | 0.4   |
|       |       | 00′   | village     | 11 km | 02 km | 87 km | 35 km |
|       |       | 36″   |             |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 3     | 0.001 | 0°    | ne          | 111 m | 102 m | 7     | 4     |
|       |       | 00′   | ighborhood, |       |       | 8.7 m | 3.5 m |
|       |       | 3.6″  | street      |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 4     | 0     | 0°    | individual  | 1     | 1     | 7     | 4     |
|       | .0001 | 00′   | street,     | 1.1 m | 0.2 m | .87 m | .35 m |
|       |       | 0.36″ | large       |       |       |       |       |
|       |       |       | buildings   |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 5     | 0.    | 0°    | individual  | 1     | 1     | 0.    | 0.    |
|       | 00001 | 00′   | trees,      | .11 m | .02 m | 787 m | 435 m |
|       |       | 0     | houses      |       |       |       |       |
|       |       | .036″ |             |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 6     | 0.0   | 0°    | individual  | 1     | 1     | 78    | 43    |
|       | 00001 | 00′   | humans      | 11 mm | 02 mm | .7 mm | .5 mm |
|       |       | 0.    |             |       |       |       |       |
|       |       | 0036″ |             |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 7     | 0.00  | 0°    | practical   | 11    | 10    | 7.    | 4.    |
|       | 00001 | 00′   | limit of    | .1 mm | .2 mm | 87 mm | 35 mm |
|       |       | 0.0   | commercial  |       |       |       |       |
|       |       | 0036″ | surveying   |       |       |       |       |
+-------+-------+-------+-------------+-------+-------+-------+-------+
| 8     | 0.000 | 0°    | specialized | 1.    | 1.    | 0.7   | 0.4   |
|       | 00001 | 00′   | surveying   | 11 mm | 02 mm | 87 mm | 35 mm |
|       |       | 0.00  | (e.         |       |       |       |       |
|       |       | 0036″ | g. tectonic |       |       |       |       |
|       |       |       | pla         |       |       |       |       |
|       |       |       | te mapping) |       |       |       |       |
